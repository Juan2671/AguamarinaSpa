...
namespace WebApplication1.Models.Paginador
{
    public class Paginador<T>
    {
        //cantidad de resultados por página 
        private int pagi_cuantos = 4;
        //cantidad de enlaces que se mostrarán como máximo en la barra de navegación 
        private int pagi_nav_num_enlaces = 3;
        private int pagi_actual;
        //definimos qué irá en el enlace a la página anterior 
        private String pagi_nav_anterior = "< anterior";
        //definimos qué irá en el enlace a la página siguiente 
        private String pagi_nav_siguiente = "siguiente > ";
        //definimos qué irá en el enlace a la página siguiente 
        private String pagi_nav_primera = "&laquo;";
        private String pagi_nav_ultima = "&raquo; ";
            ...
            String action, String host)
        {
            ...
            if (pagi_actual != 1)
            {
                ...
                pagi_navegacion += "<li>" +  "<a class='btn btn-default' href='" + host + "/" + area + "/" + controller + "/" + action
                    + "?Pag=" + pagi_url + "&Registros=" + pagi_cuantos + "'>" + pagi_nav_primera + "</a>" + "</li>";

                // Si no estamos en la página 1. Ponemos el enlace "anterior" 
                pagi_url = pagi_actual - 1; //será el número de página al que enlazamos 
                pagi_navegacion += "<li>" + "<a class='btn btn-default' href='" + host + "/" + area + "/" + controller + "/" + action
                    + "?Pag=" + pagi_url + "&Registros=" + pagi_cuantos + "'>" + pagi_nav_anterior + " </a>" + "</li>";
            }
            ...
            for (int pagi_i = pagi_nav_desde; pagi_i <= pagi_nav_hasta; pagi_i++)
            {
                ...
                else
                {
                    ...
                    pagi_navegacion += "<li class='numeros'>" + "<a class='pagination__link' href='" + host + "/" + area + "/" + controller + "/" +
            ...
            if (pagi_actual < pagi_totalPags)
            {
                ...
                pagi_navegacion += "<li>" + "<a class='pagination__link' href='" + host + "/" + area  + "/"+ controller + "/" +
                    action + "?Pag=" + pagi_url + "&Registros=" + pagi_cuantos + "'>" +
                     pagi_nav_siguiente  + "</a>" + "</li>";
        ...
        */
            ...
            String pagi_info = "<b>" + pagi_actual + "</b> - <b>" + pagi_totalPags + "</b> de <b>" +
                pagi_totalReg + "</b> <b>/" + pagi_cuantos + "</b>";

            if (query == null || query.Count == 0)
            {
                pagi_info = "No se han encontrado registros";
                pagi_navegacion = "";
            }
